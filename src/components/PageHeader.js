...
export default function PageHeader(props) {
  return (
    <div className='d-flex justify-content-center' style={{backgroundImage: `url(${props.image})`, backgroundRepeat: "no-repeat", backgroundSize: "cover"}}>
        <div className='d-flex justify-content-center flex-column align-items-center w-50 p-4' style={{background: "rgba(0, 0, 0, 0.5)", margin: '20%'}}>
            ...
            <button className='border-0' style={{backgroundColor: "#af9a7d", fontSize: "22px", letterSpacing: "3px"}}>{props.buttonTitle}</button>
        </div>
    </div>
  )
}
